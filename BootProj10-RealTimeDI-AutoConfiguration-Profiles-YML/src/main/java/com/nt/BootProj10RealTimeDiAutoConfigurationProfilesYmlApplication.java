...
public class BootProj10RealTimeDiAutoConfigurationProfilesYmlApplication {
	...
	public static void main(String[] args) {
		...
		// get IOC Container
		ctx = SpringApplication.run(BootProj10RealTimeDiAutoConfigurationProfilesYmlApplication.class, args);
