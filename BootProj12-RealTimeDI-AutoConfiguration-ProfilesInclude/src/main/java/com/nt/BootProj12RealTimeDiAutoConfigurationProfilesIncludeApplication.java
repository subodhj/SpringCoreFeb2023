...
public class BootProj12RealTimeDiAutoConfigurationProfilesIncludeApplication {
	...
	public static void main(String[] args) {
		...
		SpringApplication application = new SpringApplication(
				BootProj12RealTimeDiAutoConfigurationProfilesIncludeApplication.class);
//		application.setAdditionalProfiles("prod");
		ctx = application.run(args);

		// get IOC Container
//		ctx = SpringApplication.run(BootProj12RealTimeDiAutoConfigurationProfilesIncludeApplication.class, args); 
